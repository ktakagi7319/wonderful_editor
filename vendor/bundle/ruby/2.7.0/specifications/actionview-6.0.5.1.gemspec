# -*- encoding: utf-8 -*-
# stub: actionview 6.0.5.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.5.1/actionview/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v6.0.5.1/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.5.1/actionview" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<actionpack>.freeze, ["= 6.0.5.1"])
    s.add_development_dependency(%q<activemodel>.freeze, ["= 6.0.5.1"])
  else
