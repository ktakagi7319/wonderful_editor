...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.19.1", "< 2.0"])
    ...
    s.add_dependency(%q<rubocop-ast>.freeze, [">= 1.19.1", "< 2.0"])
